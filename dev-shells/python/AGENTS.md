...
## Confirmed Additional Services
- embedding through ollama with local model at port 11434 (docker container - offifical ollama latest)
  - embeddinggemma-300m-qat-q4_0
    - Command to pull if needed: docker exec -it ollama ollama pull embeddinggemma:300m-qat-q4_0
- reranking with flashrank (smallest model avail, should default)
- pgsql with pgvector on port 5432 (docker container)
  - local files in: /home/player00/NixOS/dev-shells/python/Mimir/containers/pgsql/